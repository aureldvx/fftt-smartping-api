...
namespace SmartpingApi\Model\Joueur;

use Carbon\Carbon;
use SmartpingApi\Enum\CategorieLicenceAdministrative;
use SmartpingApi\Enum\CertificationMedicale;
use SmartpingApi\Enum\Diplome;
use SmartpingApi\Enum\Nationalite;
